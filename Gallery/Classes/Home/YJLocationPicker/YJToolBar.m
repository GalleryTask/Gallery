...
//    [self addSubview:self.titleLabel];
    ...
    //配置
    [self.cancleButton setTitleColor:BASECOLOR_BLACK forState:UIControlStateNormal];
    [self.cancleButton.titleLabel setFont:self.font];
    
    [self.confirmButton setTitleColor:BASECOLOR_BLUE forState:UIControlStateNormal];
