...
//  cube.firstMaterial.multiply.intensity=0.5;
//  cube.firstMaterial.lightingModelName=SCNLightingModelConstant;
//  cube.firstMaterial.multiply.wrapS=
//  cube.firstMaterial.diffuse.wrapS=
//  cube.firstMaterial.multiply.wrapT=
//  cube.firstMaterial.diffuse.wrapT=SCNWrapModeRepeat;
  
  
  SCNScene *scene = [SCNScene sceneNamed:@"art.scnassets/box.DAE"];
  SCNNode *node = scene.rootNode.childNodes[1];
